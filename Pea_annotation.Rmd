...
```{r}
merc_pea <- read.delim("C:/Users/admin/Desktop/протеомные проекты/горох/annotation/mercator.results.txt", header = T, sep = "\t")
...
```{r mercator 2}
merc_pea_2 <- read.delim("C:/Users/admin/Desktop/протеомные проекты/горох/annotation/Daria.results.txt", header = T, sep = "\t")
...
```{r}
blast_koala_pea <- read.delim("C:/Users/admin/Desktop/протеомные проекты/горох/annotation/user_ko.txt", header = F, sep = "\t")
blast_koala_pea_add <- read.delim("C:/Users/admin/Desktop/протеомные проекты/горох/annotation/user_ko_definition.txt", header = F, sep = "\t")
...
```{r}
ngloc_pea <- read.delim("C:/Users/admin/Desktop/протеомика/горох/annotation/ngloc_pea.txt", header = T, sep = "\t")
...
####### Cluster analysis ############
```{r echo=FALSE}
pea_table_clust <- read.csv("C:/Users/admin/Desktop/протеомные проекты/горох/raw_tab/Pea_coat_comp.csv", header = T, sep = ";", dec = ",")[, -13]
